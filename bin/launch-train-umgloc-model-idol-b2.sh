...
JOB_NAME=umgloc_model_idol_dataset_map_building2_2
...
sbatch --job-name "$JOB_NAME" \
	...
	--epochs 125 \
    --lr 0.0003 \
	--train_list "$PROJECT_DIR"/lists/idol/known_building2.txt \
	--val_list "$PROJECT_DIR"/lists/idol/unknown_building2.txt \
    --lstm_path "$JOB_RESULTS_DIR"/checkpoints/lstm_checkpoint_27.pt