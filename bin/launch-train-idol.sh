...
JOB_NAME=umgloc_model_idol_dataset_90_oldmodel_2
...
sbatch --job-name "$JOB_NAME" \
    ...
    "$PROJECT_DIR"/src_1/main.py \
        --dataset_directory "$DATA_DIR"/datasets/rnin \
    ...
    --lr 0.0003 \
	--epochs 200 \
	--train_list "$PROJECT_DIR"/lists/rnin/train.txt \
	--val_list "$PROJECT_DIR"/lists/rnin/val.txt 