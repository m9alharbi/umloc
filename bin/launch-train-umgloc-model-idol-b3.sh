...
JOB_NAME=umgloc_model_idol_dataset_map_building3_2
...
sbatch --job-name "$JOB_NAME" \
	...
	--epochs 125 \
    --lr 0.0003 \
	--train_list "$PROJECT_DIR"/lists/idol/known_building3.txt \
	--val_list "$PROJECT_DIR"/lists/idol/unknown_building3.txt 